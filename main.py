...
st.set_page_config(page_title='NewsBrief: A Customizable and Automated News Aggregator', page_icon='./Meta/newspaper.ico')
...
def display_news(list_of_news, news_quantity):
    ...
    for news in list_of_news:
        c += 1# st.markdown(f"({c}) {news.title.text}")
...
def run():
    st.title("NewsBrief: A Customizable and Automated News Aggregator")
